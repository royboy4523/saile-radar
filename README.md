...
- **[docs/data_notes/phase2_scoring_results.md](docs/data_notes/phase2_scoring_results.md)** — What the shortage scores mean, what the Stage 2 list of 566 hospitals looks like, and how to interpret the results.
- **[docs/data_notes/phase3_vms_results.md](docs/data_notes/phase3_vms_results.md)** — What the VMS filter found: 138 direct-hire targets, 12 likely VMS, 416 uncertain. What "uncertain" means and why it's not a reason to skip a facility.
...
- **[docs/how_to_update.md](docs/how_to_update.md)** — How to refresh the data and re-run the full pipeline when new government data is published.
...
python src/scoring/model.py            # Phase 2  — Shortage scoring → 566 Stage 2 hospitals
python src/crosswalk/ein_matcher.py    # Phase 3  — Match hospitals to IRS EINs
PYTHONPATH=. python src/vms/classifier.py  # Phase 3  — VMS classification via 990 data
